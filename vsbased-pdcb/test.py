...
def test_in_train_AVDRIVE(test_loader, net, best_yi_all,epoch):
    ...
    with torch.no_grad():
        ...
        for i, (test_img, test_label, test_ves) in enumerate(test_loader):
           ...
           # for t in range(20):
           #     print(ves_seg[0][0][t+320][320].item(),ves_seg[0][0][t+320][321].item(),ves_seg[0][0][t+320][322].item(),ves_seg[0][0][t+320][323].item(),ves_seg[0][0][t+320][324].item())
            ...
            gt_acc = (tp + tn) / (tp + tn +fn +fp +matrix[1,0]+ matrix[2,0])
            yi = se + sp - 1
