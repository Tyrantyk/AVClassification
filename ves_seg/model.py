...
class ResUNet34_2task(torch.nn.Module):
    ...
    def __init__(self, in_ch, bilinear=False, layer_return=False, bias=False):
        ...
        self.finalconv_task2 = torch.nn.Conv2d(self.filters[0], 1, 1, 1, bias=bias)
    ...
    def forward(self, x):
        ...
        # enc_task1
        out_first_task1 = self.firstconv_task1(x)
        out_enc1_task1 = self.enc1_task1(out_first_task1)
        out_enc2_task1 = self.enc2_task1(out_enc1_task1)
        out_enc3_task1 = self.enc3_task1(out_enc2_task1)
        out_enc4_task1 = self.enc4_task1(out_enc3_task1)
        ...
        return torch.sigmoid(out_ves), torch.sigmoid(out_ske)
